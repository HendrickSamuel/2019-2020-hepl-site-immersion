<?php 
    ...
    if (isset($action) && !empty($action)){
        ...
        switch($action){
            case "SELECTALL" :
                try{
                    $sql = "SELECT DATE_FORMAT(Date, '%W %e %M %Y'),PlageHoraire,Intitule,Cours,PlacesDisponibles,PlacesTotal,Indus,Reseau,Gestion, Date as 'DateFormatBD' FROM coursdisponibles WHERE PlacesDisponibles > 0;";
