...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 15 mai 2020 à 09:12
...
(36, 1, 5, 157, '2020-06-09', 1, 8, 10, '08h20', '10h30', 2, '2203', 'pv2', 1, 0, 0, 'theorie'),
(37, 1, 16, 165, '2020-06-09', 1, 10, 10, '08h20', '10h30', 2, '2201', 'pv3', 1, 0, 0, 'theorie'),
(38, 1, 7, 166, '2020-06-09', 2, 8, 10, '10h20', '13h00', 2, '2203', 'AE', 1, 1, 0, 'theorie'),
(39, 1, 10, 161, '2020-05-28', 3, 1, 2, '13h30', '15h30', 3, '2303', 'AX', 0, 1, 1, 'tfe');
...
(1, 'Hendrick.Samuel@student.hepl.be', 'Hendrick', 'Samuel', 'HEPL Inpres', 1, 0, 0),
(2, 'bidon@bidon.be', 'Delaval', 'Kevin', 'INPRES', 1, 0, 0);
...
--
-- Déchargement des données de la table `inscritscours`
--

INSERT INTO `inscritscours` (`Etudiant`, `Horaire`) VALUES
(1, 36),
(1, 38),
(1, 39),
(2, 36),
